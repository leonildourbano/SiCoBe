...
namespace ProjetoSisConBens.Controllers
{
    public class CargosController : Controller
    {
        ...
        public CargosController(ProjetoSisConBensContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CargoId,CargoDescricao,CargoInstrucao")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CargoId,CargoDescricao,CargoInstrucao")] Cargo cargo)
        {
            if (id != cargo.CargoId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoSisConBensContext.Cargo'  is null.");
            }
            var cargo = await _context.Cargo.FindAsync(id);
            if (cargo != null)
            {
